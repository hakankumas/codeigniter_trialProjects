...
<html lang="tr">
	...
	<body>
        ...
        <div class="w-100 p-5 mt-5 border rounded">
          ...
          <h2 class="text-center">Kullanıcı Bilgisi Güncelleme Ekranı</h2>
          <form action="<?php echo base_url("FirstController/updateProcess/$row->id")?>" method="POST">
            <div class="mt-4">
              <label for="name" class="form-label">Ad</label>
              <input type="text"class="form-control" name="name" id="name" value="<?php echo $row->name; ?>" autofocus>
            </div>
            <div class="mt-4">
